...
import { StyleSheet, View, ScrollView, Image, Switch, Platform, ViewStyle } from 'react-native';
...
export default class TabViewExample extends BasePage {
  ...
  renderPage() {
    ...
    let customBarStyle = Platform.OS == 'android' ? undefined : {
      borderTopWidth: 0,
      shadowColor: '#ccc',
      shadowOffset: { height: -1 },
      shadowOpacity: 0.4,
    ...
    return (
      <TabView style={{ flex: 1 }}
        barStyle={custom ? customBarStyle : undefined}
        type={type}>
        <TabView.Sheet
          title='Home'
